...
class AsignacionDirectaController extends Controller {
    ...
    public function queryAction() {
        ...
        $AsignacionDirecta_repo = $entityManager->getRepository("AppBundle:AsignacionDirecta");
        $AsignacionDirectaAll = $AsignacionDirecta_repo->findAll();
        $params = array("AsignacionDirectaAll" => $AsignacionDirectaAll);
        return $this->render("asignacionDirecta/query.html.twig", $params);
    }

    public function addAction(Request $request) {
        $entityManager = $this->getDoctrine()->getManager();
        $AsignacionDirecta = new \AppBundle\Entity\AsignacionDirecta();
        $form = $this->createForm(\AppBundle\Form\AsignacionDirectaType::class, $AsignacionDirecta);
        ...
        if ($form->isSubmitted()) {
            if ($form->get('cecoInf')->getData() != null) {
                ...
                if (!$Ceco) {
                    ...
                    return $this->render("asignacionDirecta/edit.html.twig", $params);
                } else {
