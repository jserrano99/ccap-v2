...
use AppBundle\Entity\Excepcion;
...
class ExcepcionController extends Controller {
    ...
    public function queryAction(Request $request) {
        ...
        $datatable= $this->get('sg_datatables.factory')->create(\AppBundle\Datatables\ExcepcionDatatable::class);
        ...
        return $this->render('excepcion/query.html.twig', array(
                    'datatable' => $datatable,
        ));
    }
    ...
    public function addAction(Request $request) {
        ...
        $Excepcion = new \AppBundle\Entity\Excepcion();
        $form = $this->createForm(\AppBundle\Form\ExcepcionType::class, $Excepcion);
        ...
        return $this->render("excepcion/edit.html.twig", $params);
    }

    public function editAction(Request $request, $id) {
        $entityManager = $this->getDoctrine()->getManager();
        $Excepcion_repo = $entityManager->getRepository("AppBundle:Excepcion");
        ...
        if ($ImportarForm->isSubmitted()) {
            ...
            if (!empty($file) && $file != null) {
                ...
                if ($PHPExcel != null) {
                    ...
                    return $this->render("excepcion/finCarga.html.twig", $params);
                }
            }
        }

        $params = ["form" => $ImportarForm->createView()];
        return $this->render("excepcion/importar.html.twig", $params);
    }
