...
class CategController extends Controller
{
	...
	public function queryAction(Request $request)
	{
		...
		return $this->render('maestros/categ/query.html.twig', [
			'datatable' => $datatable,
		]);
	}

	public function queryByCatgenAction(Request $request, $catgen_id)
	{
		$em = $this->getDoctrine()->getManager();
		$Catgen = $em->getRepository("MaestrosBundle:CatGen")->find($catgen_id);
	...
	public function queryByGrupoCobroAction(Request $request, $grupoCobro_id)
	{
		$em = $this->getDoctrine()->getManager();
		$GrupoCobro = $em->getRepository("MaestrosBundle:GrupoCobro")->find($grupoCobro_id);
