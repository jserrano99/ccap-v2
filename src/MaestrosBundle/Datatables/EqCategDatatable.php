...
class EqCategDatatable extends AbstractDatatable {
    ...
    public function buildDatatable(array $options = array()) {
        ...
        $this->columnBuilder
                ...
                ->add('categ.codigo', Column::class, array('title' => 'Codigo Unificado', 'width' => '30px'))
                ->add('categ.descripcion', Column::class, array('title' => 'Descripción', 'width' => '320px'))
    ...
    public function getEntity() {
        return 'MaestrosBundle\Entity\EqCateg';
    }
