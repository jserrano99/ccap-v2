...
class EqCatFpDatatable extends AbstractDatatable {
    ...
    public function buildDatatable(array $options = array()) {
        ...
        $this->columnBuilder
                ...
                ->add(null, ActionColumn::class, array('title' => 'Acciones',
                    'actions' => array(
                        array('route' => 'activaEqCatFp',
                            'route_parameters' => array('eqcatfp_id' => 'id'),
                            'label' => 'Activar',
    ...
    public function getEntity() {
        return 'MaestrosBundle\Entity\EqCatFp';
    }
