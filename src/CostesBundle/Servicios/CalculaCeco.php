...
namespace CostesBundle\Servicios;
...
class CalculaCeco {
    ...
    public function calculaCeco() {
        ...
        switch ($tipoUnidadFuncional) {
            case '00': // SERVICIOS CENTRALES PENDIENTE DE REVISAR CODIFICACIÓN  
                ...
                if ($tipoPuesto == '25' or $tipoPuesto == '29') {
    ...
    public function asignacionDirecta($codigoUf78) {
        ...
        $AsignacionDirecta_repo = $this->entityManager->getRepository("CostesBundle:AsignacionDirecta");
