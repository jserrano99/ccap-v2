...
/**
 * Class AdscripcionPlazaDatatable
 *
 * @package CostesBundle\Datatables
 */
class AdscripcionPlazaDatatable extends AbstractDatatable
{
	...
	public function buildDatatable(array $options = [])
	{
		...
		$this->columnBuilder
			...
			->add('plaza.cias', Column::class, [
				...
				'width' => '120px',
				'default_content' => ''])
			->add('unidadOrganizativa.codigo', Column::class, [
				'title' => 'Codigo',
				'width' => '120px',
				'default_content' => ''])
	...
	{
		return 'CostesBundle\Entity\AdscripcionPlaza';
	}
	...
	{
		return 'adscripcionPlaza_datatable';
	}
