...
try {
    $sentencia = "select * from plazas where cias = :cias";
    $params=[":cias" => $cias];
...
foreach ($resultSet as $row) {
    try {
        ...
        $params = array(":cias" => $row["CIAS"],
            ...
            ":moa_id" => selectModalidad($row["MODALIDAD"]),
